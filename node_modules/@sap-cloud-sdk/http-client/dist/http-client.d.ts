 ...
 * @internal
 */
export declare function execute<ReturnT>(executeFn: ExecuteHttpRequestFn<ReturnT>): <T extends HttpRequestConfigWithOrigin>(destination: DestinationOrFetchOptions, requestConfig: T, options?: HttpRequestOptions | undefined) => Promise<ReturnT>;
/**
